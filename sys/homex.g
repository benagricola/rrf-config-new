...
G53 G1 H1 X{-(move.axes[0].max - move.axes[0].min + global.miloHomingDist) } F{global.miloHomingSpeedFast}
...
G53 G1 H1 X{-global.miloHomingDist*2} F{global.miloHomingSpeedSlow}
