...
G53 G1 H1 Y{ move.axes[1].max - move.axes[1].min + global.miloHomingDist } F{global.miloHomingSpeedFast}
...
G53 G1 H1 Y{global.miloHomingDist*2} F{global.miloHomingSpeedSlow}
